...
-- nvim-ufo keybinds
nnoremap("<leader>zR", require("ufo").openAllFolds, { desc = "open all folds", buffer = buffer_number })
nnoremap("<leader>zM", require("ufo").closeAllFolds, { desc = "close all folds", buffer = buffer_number })
